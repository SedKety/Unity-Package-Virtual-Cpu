...
/// <summary>
/// Reads user input and stores it in a register or memory address.
/// Takes: EAX=0x00, EBX=<see cref="STDLibSyscall.SysRead"/>, ECX=InputMode (0=byte, 1=char, 2=string), EDX=destination (register index or memory address).
/// </summary>
[SyscallLibrary(0x00)]
public class SysRead : ISyscall
{
    public byte ID => (byte)STDLibSyscall.SysRead;
